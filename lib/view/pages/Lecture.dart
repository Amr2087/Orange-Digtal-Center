      ...
      debugShowCheckedModeBanner: false,
        home: Scaffold(
            appBar: AppBar(
              ...
              title: Text("Lectures", style: TextStyle(fontSize: 22, color: Colors.black)),
              backgroundColor: Colors.white,
              leading: IconButton(onPressed: () {
                  ...
                  Center(
                    child: SafeArea(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return C_card(
                              coursename: myCubit.modelData!.data![index].lectureSubject.toString(),
                              duration: "2hrs",
                              day: myCubit.modelData!.data![index].lectureDate.toString(),
                              start: myCubit.modelData!.data![index].lectureStartTime.toString(),
                              end: myCubit.modelData!.data![index].lectureEndTime.toString(),
                            );
                          },
                        )),
                  );
